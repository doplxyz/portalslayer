...
// @version        0.9.12
// @description    [0.9.12] Expert Mode (God Eye), Request Throttling. Android向け。指定レベル・陣営のポータルをタップ時にマーカー(▼)付与。ポータル名強制表示対応。エリア管理・リスト表示機能追加。ズームレベル表示位置修正・描画距離設定削除。
// @id             portal-slayer
...
(function() {
  var info = { "script": { "name": "IITC plugin: PortalSlayer", "version": "0.9.12", "description": "[0.9.12] Expert Mode (God Eye), Request Throttling. Android向け。指定レベル・陣営のポータルをタップ時にマーカー(▼)付与。ポータル名強制表示対応。エリア管理・リスト表示機能追加。ズームレベル表示位置修正・描画距離設定削除。" } };
