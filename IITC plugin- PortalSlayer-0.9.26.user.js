...
// @version        0.9.26
// @description    [0.9.26] Faction-based Portal Counter
// @id             portal-slayer
...
function wrapper(plugin_info) {
  ...
  S.isToggleMode = false; // [15] Toggle Mode
  S.guidToLayer = {};
  ...
  S.onPortalSelected = function(data) {
    ...
    // [15] Toggle Mode Check
    if (!S.isToggleMode) return;
...
(function() {
  var info = { "script": { "name": "IITC plugin: PortalSlayer", "version": "0.9.26", "description": "[0.9.26] Faction-based Portal Counter" } };
