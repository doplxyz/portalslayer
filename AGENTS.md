...
例1、p4色でマーカーを付けたポータルが、p8にレベルアップしてる場合、マーカーの色を変更する。
例2、p8ポータルが攻撃によりレベルを下げたとき、ポータルレベルは下がっているため指定のポータルレベルのマーカーに状態を変更する。チェック無しレベルに該当する場合、マーカーを削除する。この機能は、ポータルレベル変動に応じてマーカーを変動させる旨のチェックボックスにてON/OFF可能にする。
