...
// @version        0.9.28
// @description    [0.9.28] Faction-based Portal Counter
// @id             portal-slayer
      ...
      <div class="portal-slayer-settings">
        <div class="ps-header">
           ...
           <div style="margin-top:8px; border-top:1px solid #444; padding-top:4px;">
             ...
             <div style="margin-top:4px;"><label><input type="checkbox" id="ps-auto-update" ${S.options.autoUpdateMarkers ? 'checked' : ''}> [16] ポータル変化時にマーカーを自動更新/削除</label></div>
           </div>
...
(function() {
  var info = { "script": { "name": "IITC plugin: PortalSlayer", "version": "0.9.28", "description": "[0.9.28] Faction-based Portal Counter" } };
